...
function CreateTripPage() {
  ...
  const [stops, setStops] = useState([{ order: 1, name: '', location: '', days: '' }]);
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Full tripData being sent:', JSON.stringify(tripData, null, 2)); // Debug log
    try {
      console.log('Submitting trip with detailed stops:', JSON.stringify(tripData, null, 2));
      const newPost = await dispatch(createPostThunk(tripData));
